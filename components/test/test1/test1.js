...
let quest = [{
        text: "1. Самая мелкая структурная единица организма, наделенная всеми основными признаками живого, — это:",
        answers: ["клетка",
            "ткань",
            "орган",
            "система органов"
    ...
    {
        text: "2. Единица функционирования живых организмов – это:",
        answers: ["клетка",
            "ткань",
            "орган",
            "система органов"
    ...
    {
        text: "3. Единица развития живых организмов – это ",
        answers: ["клетка",
            "ткань",
            "орган",
            "система органов"
    ...
    {
        text: "4. Наука о строении, химическом составе и функции клеток, их размножении, развитии и взаимодействия в многоклеточном организме – это:",
        answers: ["цитология",
            "эмбриология",
            "гистология",
            "экология"
    ...
    {
        text: "5. Основным методом исследования в цитологии является следующий:",
        answers: ["микроскопический",
            "гистологический",
    ...
    {
        text: "6. С помощью каких методов устанавливают локализацию различных компонентов в клетках?",
        answers: ["микроскопических",
            "гистологических",
            "рентгеноструктурного анализа",
            "авторадиографии"
    ...
    {
        text: "7. Для изучения тончайших структур клеток в цитологии применяют метод:",
        answers: ["электронной микроскопии",
            "биохимических",
            "рентгеноструктурного анализа",
            "авторадиографии"
        ],
    ...
    {
        text: "8. Изучение химического состава и биохимических реакций в цитологии осуществляется с помощью методов:",
        answers: ["электронной микроскопии",
            "биохимических",
            "рентгеноструктурного анализа",
            "авторадиографии"
    ...
    {
        text: "9. Исследование пространственной конфигурации и физических свойств макромолекул в цитологии осуществляется с помощью методов:",
        answers: ["электронной микроскопии",
            "биохимических",
            "рентгеноструктурного анализа",
            "авторадиография"
    ...
    {
        text: "10. Процессы матричного синтеза и деления клеток в цитологии изучают с помощью методов:",
        answers: ["электронной микроскопии",
            "биохимических",
            "рентгеноструктурного анализа",
            "авторадиографии"
